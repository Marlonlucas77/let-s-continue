...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Compare qualquer time do mundo com IA generativa e receba probabilidades de gols, escanteios e cartões na hora. Planos a partir de R$ 4,99/mês." },
      { property: "og:title", content: "Placar Certo — Previsões de futebol com IA" },
      { property: "og:description", content: "Compare qualquer time do mundo com IA generativa e receba probabilidades de gols, escanteios e cartões na hora. Planos a partir de R$ 4,99/mês." },
      ...
      { name: "twitter:description", content: "Compare qualquer time do mundo com IA generativa e receba probabilidades de gols, escanteios e cartões na hora. Planos a partir de R$ 4,99/mês." },
